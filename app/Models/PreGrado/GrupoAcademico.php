...
{
    protected   $table = 'ep_grupo_academico';
    ...
    public static function runNew($r)
    {
        ...
        for ($i=0; $i < count($local_id) ; $i++) { 
            ...
            if( !isset($grupoAcademico->id) ){
                ...
                $grupoAcademico->ciclo_id = trim( $r->ciclo_id );
    ...
    {
        $sql=DB::table('ep_grupo_academico AS ga')
            ...
            ->where( 
                function($query) use ($r){
                    ...
                    if( $r->has("ciclo_id") ){
                        ...
                        if( $ciclo_id !='' ){
                            $query->where('ga.ciclo_id','=',$ciclo_id);
                        }
                        elseif($r->has('plan_estudio_id')){

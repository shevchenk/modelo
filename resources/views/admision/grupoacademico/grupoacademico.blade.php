...
@section('include')
    ...
    @include( 'admision.grupoacademico.js.grupoacademico_ajax' )
    @include( 'admision.grupoacademico.js.grupoacademico' )
@stop
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Grupo Académico Admisión</h2>
                                    <p>Gestionar los grupos académicos admisión</p>
                                </div>
                            </div>
                        </div>
                    </div>

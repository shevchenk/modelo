...
@section('include')
    ...
    @include( 'ingreso.pslocalusuario.js.pslocalusuario_ajax' )
    @include( 'ingreso.pslocalusuario.js.pslocalusuario' )
...
@section('form')
     @include( 'ingreso.pslocalusuario.form.pslocalusuario' )
@stop

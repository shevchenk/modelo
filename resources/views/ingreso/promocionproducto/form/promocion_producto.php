    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header btn-info">
                ...
                <h4 class="modal-title">Promociones de los Productos</h4>
            </div>
            <div class="modal-body">
                <form id="ModalPromocionForm">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label>Oferta</label>
                            <textarea placeholder="Oferta del Producto" rows="3" class="form-control" id="txt_oferta" name="txt_oferta"></textarea>
                        </div> 
                        <div class="col-md-4">

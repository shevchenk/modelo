...
@section('include')
    ...
    @include( 'ingreso.promocionproducto.js.promocion_producto_ajax' )
    @include( 'ingreso.promocionproducto.js.promocion_producto' )
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Promociones de los Productos</h2>
                                    <p>Gestionar las promociones de los productos</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('form')
     @include( 'ingreso.promocionproducto.form.promocion_producto' )
@stop

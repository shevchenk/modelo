...
ValidaForm1=function(){
    ...
    if( $.trim( $("#ModalNivel1Form #txt_nivel1").val() )=='' ){
        r=false;
        msjG.mensaje('warning','Ingrese Grupo',4000);
    }
...
CambiarEstado1=function(estado,id){
    ...
    sweetalertG.confirm('Grupos','Desea '+texto+' el grupo: '+$("#TableNivel1 #trid_"+id+" .nivel1").text(), function(){ AjaxNivel1.CambiarEstado1(HTMLCambiarEstado1,estado,id); });
}

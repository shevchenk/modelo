...
@include( 'ingreso.producto.js.producto_ajax' )
@include( 'ingreso.producto.js.producto' )
@include( 'ingreso.producto.js.nivel2_ajax' )
@include( 'ingreso.producto.js.nivel2' )
@include( 'ingreso.producto.js.nivel1_ajax' )
@include( 'ingreso.producto.js.nivel1' )
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    ...
                                    <p>Gestionar los Productos de brinda empresa</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="data-table-list">
                    <div class="widget-tabs-list tab-pt-mg">
                        <ul class="nav nav-tabs tab-nav-center">
                            <li class="active"><a data-toggle="tab" href="#MPnivel3">Producto</a></li>
                                            ...
                                            <table id="TableNivel3" class="table table-bordered table-hover">
                                                <thead>
                                                    <tr class="cabecera">
                                                        ...
                                                        <th class="col-xs-4">
                                                            <div class="form-group col-xs-12">
                                                                <label><h4>Producto:</h4></label><br>
                                                                <div class="input-group col-xs-12">
                                                                    <div class="input-group-addon"><i class="fa fa-search"></i></div>
                                                                    <input type="text" class="form-control" name="txt_nivel3" id="txt_nivel3" placeholder="Producto" onkeypress="return masterG.enterGlobal(event, '.input-group', 1);">
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <th class="col-xs-3">
...
@section('form')
@include( 'ingreso.producto.form.producto' )
@include( 'ingreso.producto.form.nivel2' )
@include( 'ingreso.producto.form.nivel1' )
@stop

...
var AjaxPrivilegio={
    ...
    ListOpcion:function(evento,id){
        $("#ModalPrivilegioForm").append("<input type='hidden' value='"+id+"' name='privilegio_id'>");
        data=$("#ModalPrivilegioForm").serialize().split("txt_").join("").split("slct_").join("");
        $("#ModalPrivilegioForm input[type='hidden']").not('.mant').remove();
        url='AjaxDinamic/Mantenimiento.PrivilegioMA@ListOpcion';

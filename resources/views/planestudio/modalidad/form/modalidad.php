                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return masterG.validaAlfanumerico(event, this);" class="form-control" id="txt_modalidad" name="txt_modalidad" maxlength="100" placeholder="Modalidad de Estudio">
                            </div>
                        </div> 
                        <div class="col-md-12">
                            <div class="form-group">

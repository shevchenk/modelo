...
@section('include')
    ...
    @include( 'pregrado.grupoacademicovir.js.grupoacademicovir_ajax' )
    @include( 'pregrado.grupoacademicovir.js.grupoacademicovir' )
@stop
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcomb-wp">
                                ...
                                <div class="breadcomb-ctn">
                                    <h2>Grupo Académico Virtual</h2>
                                    <p>Gestionar los grupos académicos virtual</p>
                                </div>
                            </div>
                        </div>
                    </div>
